...
function Feature({
...
}) {
    {
        ...
        return (
            ...
            >
                <div className="h-28 w-full md:h-[7rem] md:w-[47%] lg:h-[9.75rem] xl:h-[12rem]">
                    <img
                        src={imageSrc}
                        alt="image"
                ...
                <div className="flex w-full flex-col justify-center gap-1 p-2 sm:p-4 md:w-[47%] md:gap-2 lg:h-52 xl:h-60 xl:gap-3">
