...
function Footer() {
    return (
        <footer className="mx-auto grid h-80 w-full grid-cols-2 grid-rows-5 rounded-lg bg-stone-300 shadow-[0px_0px_5px_1px_white_inset] ring-[0.25px] ring-neutral-800 dark:bg-stone-800 dark:shadow-[0px_0px_5px_1px_black_inset] dark:ring-neutral-100">
            <div className="row-span-2 flex h-full w-full items-center justify-between px-8">
            ...
            <div className="row-span-2 flex h-full w-full items-center justify-end px-8">
                <SocialLinks />
            </div>
            <div className="col-span-2 row-span-2 grid h-full w-full grid-cols-2 grid-rows-1">
